...
from sysatlas import BPMNMap, ClassMap, ERMap, SequenceMap, StateMap, SystemMap, System, TreeMap
...
def run(demo: str) -> None:
    ...
    _redirect(StateMap, target)
    _redirect(ClassMap, target)
    _redirect(BPMNMap, target)
